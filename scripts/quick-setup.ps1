...
$PROJECT_ID = "perfect-zenkai-auth"  # You may need to adjust this
...
Write-Host "`n📚 Google Cloud Console URLs" -ForegroundColor Yellow
Write-Host "============================="
Write-Host "OAuth Consent Screen: https://console.cloud.google.com/apis/credentials/consent?project=$PROJECT_NUMBER"
Write-Host "Credentials: https://console.cloud.google.com/apis/credentials?project=$PROJECT_NUMBER"
Write-Host "APIs Library: https://console.cloud.google.com/apis/library?project=$PROJECT_NUMBER" 