...
**User Story:** _As a developer, I can unit-test hooks & components easily with proper providers._
...
**User Story:** _As a developer, I can run e2e tests in mobile viewport automatically._
...
**User Story:** _As a product owner, build fails if PWA score dips below 90._
...
**User Story:** _As a team, all PRs run lint, unit, e2e, lighthouse automatically._
